package com.example.facerecognize3.tflite;
...
public interface SimilarityClassifier
{
    ...
    void setUseNNAPI( boolean isChecked, AssetManager assets, String tfOdApiModelFile );
    ...
    public class Recognition
    {
        ...
        /**
         * A sortable score for how good the recognition is relative to others. Lower should be
         * better.
         */
